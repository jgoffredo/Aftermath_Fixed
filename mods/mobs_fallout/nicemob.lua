...
--Maikerumine added hackish follow code
	on_rightclick = function (self, clicker)
		...
		local_chat(clicker:get_pos(),"Old man: I am getting too old for this...  Okay, I'll help ya!",3)
...
--Maikerumine added hackish follow code
	on_rightclick = function (self, clicker)
		...
		mobs:team_player(self,clicker:get_pos())
		if self.state ~= "path" and self.state ~= "following" then
		local_chat(clicker:get_pos(),"Old woman: I may walk slow, but I can fight like a champ!",3)
			if not self.tamed then
				self.tamed = true
				self.follow = true
			end
