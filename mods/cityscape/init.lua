...
cityscape.vacancies = tonumber(minetest.settings:get('cityscape_vacancies')) or 3
if cityscape.vacancies < 0 or cityscape.vacancies > 10 then
	cityscape.vacancies = 0
end
cityscape.desolation = tonumber(minetest.settings:get('cityscape_desolation')) or 9
if cityscape.desolation < 0 or cityscape.desolation > 10 then
	cityscape.desolation = 0
end
cityscape.suburbs = tonumber(minetest.settings:get('cityscape_suburbs')) or 2
...
minetest.register_chatcommand("saveplot", {
	...
	func = function(name, param)
		...
		local csize = (minetest.settings:get("chunksize") or 5) * 16
